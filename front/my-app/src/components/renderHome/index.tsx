        ...
        <div className="h-screen bg-custom-image bg-no-repeat bg-size-200 text-white">
            <div className="flex justify-center items-center h-full gap-12">
                <div className="w-1/2 mt-10">
                    ...
                    <Link href="/Hire"><button className=" w-48 transition-all duration-300 bg-yellowinti hover:bg-lightorangeinti text-black font-medium py-2 px-6 rounded-full ml-12" >View services</button></Link>
